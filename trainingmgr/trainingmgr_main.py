...
from trainingmgr.common.trainingmgr_util import get_one_word_status, check_trainingjob_data, \
    ...
    validate_trainingjob_name, get_all_pipeline_names_svc, check_feature_group_data, check_trainingjobname_and_version, check_trainingjob_name_or_featuregroup_name
...
def get_trainingjob_by_name_version(trainingjob_name, version):
    ...
    response_data = {}
    if not check_trainingjobname_and_version(trainingjob_name, version):
        return {"Exception":"The trainingjob_name or version in not correct"}, status.HTTP_400_BAD_REQUEST
