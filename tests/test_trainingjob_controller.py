...
class TestGetTrainingJobInfosFromModelId:
    ...
    @patch('trainingmgr.controller.trainingjob_controller.fetch_trainingjob_infos_from_modelId')
    ...
    @patch('trainingmgr.controller.trainingjob_controller.fetch_trainingjob_infos_from_modelId', side_effect = Exception("Generic exception"))
